...
struct A {
  virtual char virtual_name() const { return 'A'; }
  char direct_name() const { return 'A'; }
};
struct B : public A {
  // READ: override <https://zh.cppreference.com/w/cpp/language/override>
  char virtual_name() const override { return 'B'; }
  char direct_name() const { return 'B'; }
};
struct C : public B {
  // READ: final <https://zh.cppreference.com/w/cpp/language/final>
  char virtual_name() const final { return 'C'; }
  char direct_name() const { return 'C'; }
};
struct D : public C {
...
// READ: 扩展阅读-纯虚、抽象
// <https://zh.cppreference.com/w/cpp/language/abstract_class> READ:
// 扩展阅读-虚继承 <https://zh.cppreference.com/w/cpp/language/derived_class>
